...
public class FloatOption extends Option<Float> {
    ...
    public FloatOption(String title, float defaultValue, float min, float max,
                       Supplier<Float> getter, Consumer<Float> setter, String d, ConfigCategory configCategory) {
